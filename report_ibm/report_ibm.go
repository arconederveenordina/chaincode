...
func (t *SimpleChaincode) setmeterstatus(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var name string
	var val bool
	var err error
...
func (t *SimpleChaincode) reported_kwh(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var name string // Entities
	var err error
...
func (t *SimpleChaincode) status(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var name string // Entities
	var err error
...
func (t *SimpleChaincode) complete_meter_state(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	var name string // Entities
	var err error
...
func (t *SimpleChaincode) MeterEnabled(stub *shim.ChaincodeStub, meterName string) (bool, error) {
	var name string // Entities
	var err error
